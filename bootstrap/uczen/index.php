...
<!--	<link rel="stylesheet" href="C:/xampp/htdocs/bootstrap/todo/css/style.css">-->
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="index.php"> Strefa Ucznia</a></li>
            <li><a href="pages.php">Zadania</a></li>
            <li><a href="posts.php">Oceny</a></li>
...
-->
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Strefa Ucznia <small></small></h1>
          </div>
          <div class="col-md-2">
    ...
    <section id="breadcrumb">
      <div class="container">
        <ol class="breadcrumb">
          <li class="active">Strefa Ucznia</li>
        </ol>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="well">
              <h4>Procent zrealizowanych zadań </h4>
              <div class="progress">
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> 50</h2>
                    <h4>Ilość zrobionych zadań</h4>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> 12</h2>
                    <h4>Ilość zadań do zrobienia</h4>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span> 4,5</h2>
                    <h4>Średnia ocen</h4>
                  </div>
                </div>
                <div class="col-md-3">
              ...
              <div class="panel panel-default" >
                ...
                <div class="panel-heading main-color-bg">
                        <h3 class="panel-title" >Co umiem?</h3>
                </div>
                  <center>
