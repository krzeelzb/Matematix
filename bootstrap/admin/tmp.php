    ...
    <nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="http://localhost/bootstrap/index1.php">Matematix</a>
        </div>
...
-->
   ...
   <h1 align="center">Dziennik</h1>
   <br />
   <div class="table-responsive">
   <br />
    <div align="right">
     <button type="button" name="add" id="add" class="btn btn-info">Dodaj</button>
    </div>
    <br />
